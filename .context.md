...
## Current Session Changes (2026-02-13)
...
4. **Added video/embed support** - YouTube, Vimeo, and Notion embeds
...
#### 3. `lib/notion.ts`
**What Changed:**
- Added support for `video` blocks (embedded videos from Notion)
